...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { bepoint: @trade.bepoint, buy_date: @trade.buy_date, buy_price: @trade.buy_price, qty: @trade.qty, stock: @trade.stock }
    end
  ...
  test "should update trade" do
    put :update, id: @trade, trade: { bepoint: @trade.bepoint, buy_date: @trade.buy_date, buy_price: @trade.buy_price, qty: @trade.qty, stock: @trade.stock }
    assert_redirected_to trade_path(assigns(:trade))
  end
